    ...
    <Card className="group p-5 flex flex-col justify-between h-full">
      <div className="space-y-4">
        ...
        <div className="flex items-start space-x-4">
          <div className="w-20 h-20 rounded-2xl bg-slate-100 dark:bg-slate-800 overflow-hidden flex-shrink-0 border border-slate-200 dark:border-slate-700/60">
            <img
          ...
          <div>
            ...
            <div className="mt-2 text-xs font-bold text-emerald-600 dark:text-emerald-400 flex items-center">
