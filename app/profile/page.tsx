      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-y-auto">
        <header className="h-16 bg-[#060B14]/90 backdrop-blur-xl border-b border-slate-800/80 px-6 flex items-center justify-between sticky top-0 z-30">
          <div className="flex items-center space-x-2 text-xs font-mono font-semibold text-slate-400">
            ...
            <span className="text-white font-bold">Shop Profile & WhatsApp Metadata</span>
          </div>
        </header>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#0F172A] border border-slate-800 rounded-xl px-3.5 py-2.5 text-sm text-white focus:outline-none focus:border-emerald-500"
                />
              </div>
              ...
              <div className="sm:col-span-2">
                <label className="text-xs font-semibold text-slate-400 block mb-1">Physical Address</label>
                <input
                  type="text"
                  required
                  value={address}
              ...
              <div className="sm:col-span-2">
                ...
                <textarea
                  ...
                  className="w-full bg-[#0F172A] border border-slate-800 rounded-xl px-3.5 py-2.5 text-sm text-white focus:outline-none focus:border-emerald-500 resize-none"
                />
              </div>
            </div>
