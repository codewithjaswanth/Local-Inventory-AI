...
export const AI_REVIEW_QUEUE: AiReviewItem[] = [
  {
    ...
    audioSnippet: '🎙️ "Just received 40kg organic Alphonso Mangoes at $3.99 per lb"',
  ...
  },
  {
    ...
    source: 'WhatsApp Voice Note',
    audioSnippet: '🎙️ "15 bottles grass fed glass bottle milk arrived $4.20 each"',
...
export const CUSTOMER_FEEDBACK_DATA: FeedbackItem[] = [
  ...
  },
  {
    ...
    comment: 'WhatsApp voice update was super accurate. Price matched $1.99 each.',
    accuracyScore: 98,
    earnedTokens: 10,
  },
  {
...
export const PORTAL_NOTIFICATIONS: PortalNotification[] = [
  ...
  },
  {
    ...
    message: 'Organic Vine Tomatoes are trending in your 1-mile radius (420 searches today).',
    type: 'alert',
    timestamp: '1h ago',
    read: true,
  },
